...
(function() {
  ...
  angular
    .module('horizon.app.resources.os-cinder-volumes.actions')
    .factory('horizon.app.resources.os-cinder-volumes.actions.launch-instance.service', launchInstanceService);
