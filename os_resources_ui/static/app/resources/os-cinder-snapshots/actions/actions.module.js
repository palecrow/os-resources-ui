...
(function() {
  ...
  /**
   * @ngdoc overview
   * @ngname horizon.app.resources.os-cinder-snapshots.actions
   *
   * @description
   * Provides all of the actions for volume snapshots.
   */
  angular.module('horizon.app.resources.os-cinder-snapshots.actions',
    ['horizon.framework.conf', 'horizon.app.core'])
    .run(run);

  run.$inject = [
    'horizon.framework.conf.resource-type-registry.service',
    'horizon.app.resources.os-cinder-snapshots.actions.launch-instance.service',
