...
(function() {
  ...
  describe('ServerOverviewController', function() {
    ...
    beforeEach(module('horizon.app.core.instances.details'));
    ...
    describe('ruleToString', function() {
      ...
      it('produces expected output', function() {
        var useCases = [
          [
            {ethertype: 'IPv4', direction: 'ingress', remote_ip_prefix: '10.0.0.1'},
            "ALLOW IPv4 from 10.0.0.1"
          ],
          [
            {ethertype: 'IPv6', direction: 'egress', remote_ip_prefix: null},
            "ALLOW IPv6 to default"
          ]
        ];
