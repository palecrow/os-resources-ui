...
(function() {
  ...
  describe('horizon.app.core.instances.actions.launch-instance.service', function() {
    ...
    beforeEach(inject(function($injector, _$timeout_) {
      service = $injector.get('horizon.app.core.instances.actions.launch-instance.service');
