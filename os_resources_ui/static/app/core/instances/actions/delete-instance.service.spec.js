...
(function() {
  ...
  describe('horizon.app.core.instances.actions.delete-instance.service', function() {

    var service, $timeout, $q;

    beforeEach(module('horizon.app.core.instances.actions'));
    beforeEach(inject(function($injector, _$timeout_, _$q_) {
      service = $injector.get('horizon.app.core.instances.actions.delete-instance.service');
      $timeout = _$timeout_;
      $q = _$q_;
    }));
