...
(function () {
  ...
  angular
    ...
    .factory('horizon.app.core.instances.actions.edit-instance-security-groups', service);
  ...
  function service(serverSideActionService) {
    ...
    var serverSideAction = serverSideActionService.getAction('EditInstanceSecurityGroups');
