...
(function() {
  ...
  describe('horizon.app.core.instances.actions.create-snapshot.service', function() {
    ...
    beforeEach(inject(function($injector, _$q_, _$timeout_) {
      service = $injector.get('horizon.app.core.instances.actions.create-snapshot.service');
